<template>
  <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg w-full max-w-2xl">
      ...
      <button
        ...
        :class="[
          selectedCurrencies.includes(currency)
            ? 'border-lavender-400 bg-lavender-100 dark:bg-lavender-900'
    ...
    <button
      class="mt-6 w-full py-2 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded hover:bg-gray-300 dark:hover:bg-gray-600"
      @click="$emit('close')"
    >
      Close
    </button>
